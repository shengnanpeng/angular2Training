...
import { LoginCommodityComponent } from '../pages/commodity/login-commodity/login-commodity.component';
const SPAroutes: Routes = [
  ...
  { path: 'commodity-management', component: LoginCommodityComponent },
];
